Riotshield UI Library

Introducing the Riotshield UI Library, a Roblox Exploit UI Library created just for fun! Feel free to modify it as you wish, and using our library has already helped us a lot! You can check out an example code here.

Source Code

Actual Source (Rbxm) (LOST.)

Getting Started

To begin, you need to declare a variable to access the library.

local RiotshieldLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/DrRay-UI-Library/main/DrRay.lua"))()
To load the UI, simply call the function:

local window = RiotshieldLibrary:Load("Riot", "Default")
...
local tab = RiotshieldLibrary.newTab("My Tab", "ImageIdHere")
...
This UI library made by riot._._._ (Discord)

Enjoy using the Riotshield UI Library! Have fun.
